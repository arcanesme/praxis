...
After any AI tool edits code, the following hooks run automatically (configured per-project in `praxis/verification.md`):
...
Hooks are defined in `praxis/verification.md` and executed by the `verify` command.
